...
## [1.2.0](https://github.com/danielscholl-osdu/partition/compare/v1.1.0...v1.2.0) (2026-06-03)
...
* **ci:** Remove IBM pipeline configurations from GitLab CI ([7a3dad9](https://github.com/danielscholl-osdu/partition/commit/7a3dad9bea62a8bfc34723066ba374dec1d18aa7))
* Complete repository initialization ([49bc77e](https://github.com/danielscholl-osdu/partition/commit/49bc77e025458abd204507c27d49c8c5bd65aab5))
* Copy configuration and workflows from main branch ([f0ce872](https://github.com/danielscholl-osdu/partition/commit/f0ce872f4da8af63a08f38227aa405fafe92cee6))
...
* **docs:** Update NOTICE with corrected URLs for Awaitility and Bean Validation API ([7a3dad9](https://github.com/danielscholl-osdu/partition/commit/7a3dad9bea62a8bfc34723066ba374dec1d18aa7))
...
* Sync template updates ([4fd2d1f](https://github.com/danielscholl-osdu/partition/commit/4fd2d1f50b006c7e756b4152442acc4caa617f78))
* Sync template updates ([fdac8b6](https://github.com/danielscholl-osdu/partition/commit/fdac8b6f7c489883bc94cb57afe68366ef1f4ed1))
* Sync template updates ([e31077e](https://github.com/danielscholl-osdu/partition/commit/e31077e38d4f42a8d9289188d2b8cf142b488608))
* Sync template updates ([63068a1](https://github.com/danielscholl-osdu/partition/commit/63068a17cff20537b6bcd87cc4f3f287bc855869))
* Sync template updates ([9ff32ba](https://github.com/danielscholl-osdu/partition/commit/9ff32ba5802b1c19e7d20390034217a34cfcd399))
* Sync template updates ([d25928d](https://github.com/danielscholl-osdu/partition/commit/d25928d1bac39b5890fab5c39d52106a9621f8c6))
* **sync:** Template updates 2026-06-03 ([41628e8](https://github.com/danielscholl-osdu/partition/commit/41628e88b45dec60c36f2c8eabaa8079fb04b552))
* **sync:** Template updates 2026-06-03 ([e6a5d59](https://github.com/danielscholl-osdu/partition/commit/e6a5d59b7a5ee15d8c7daac595e098c2bd0c35c8))
* **sync:** Template updates 2026-06-03 ([4c57f4b](https://github.com/danielscholl-osdu/partition/commit/4c57f4b1baf7848dc969d721c6d4da23f3f00a24))
* **sync:** Template updates 2026-06-03 ([3c49321](https://github.com/danielscholl-osdu/partition/commit/3c49321710f6d8683aa96b6949a04713e473c987))
