...
import org.opengroup.osdu.api.PartitionSystemApi;
...
public class PartitionSystemController implements PartitionSystemApi {
  ...
  public Map<String, Property> get() {
    return partitionService.getPartition(configuration.getSystemPartitionId()).getProperties();
  }
}
